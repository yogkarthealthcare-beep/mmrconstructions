...
export class ServicesComponent implements OnInit {
  ...
  ngOnInit() {
    this.seo.set({
      title: 'Our Services | Real Estate, Construction & Interior Design | MMR Construction',
      description: 'Explore MMR Construction services for plot buying and selling, farmhouse deals, ready-to-move homes, construction, and interior design.',
      keywords: 'MMR Construction services, plot buying, plot selling, farmhouse property, house construction, ready to move homes, interior design',
      canonical: '/services',
      schema: {
        '@context': 'https://schema.org',
        '@type': 'Service',
        name: 'MMR Construction Real Estate and Construction Services',
        provider: {
          '@type': 'Organization',
          name: 'MMR Construction & Developers Pvt. Ltd.',
