...
export class CustomersComponent implements OnInit {
  ...
  openEditModal(c: any) {
    ...
    this.customerForm = {
      ...
      address: c.address?.address_line1 || c.address_line1 || c.address || c.permanent_address || c.present_address || '',
      city: c.city || c.address?.city || c.permanent_city || c.present_city || '',
      state: c.state || c.address?.state || c.permanent_state_pin || c.present_state_pin || '',
      pin_code: c.pin_code || c.address?.pin_code || c.pincode || c.permanent_state_pin || '',
      new_password: '',
      confirm_password: '',
